...
AddonID='plugin.video.KodiBuildWizard'
AddonTitle="The Kodi Build Wizard"
            ...
            for root, dirs, files in os.walk(xbmcPath,topdown=True):
                ...
                for name in dirs:
                    try: os.rmdir(os.path.join(root,name))
                        ...
                        plugintools.log("Error removing "+root+" "+name)
            if not failed: plugintools.log("freshstart.main_list All user files removed, you now have a clean install"); plugintools.message(AddonTitle,"The process is complete!","Please reboot your system or restart Kodi in order for the changes to be applied.")
            else: plugintools.log("freshstart.main_list User files partially removed"); plugintools.message(AddonTitle,"The process is complete!","Please reboot your system or restart Kodi in order for the changes to be applied.")
